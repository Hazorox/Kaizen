  ...
  return (
    <AnimatePresence>
      {data && (
        ...
        >
          {/* Content */}
          <motion.div className={`flex overflow-y-auto overflow-x-hidden scrollable  gap-4 text-[#fffbe6] flex-col`}>
      ...
      {!data && (
        <motion.div className={`${sub?"h-[55%]":"h-full"} flex justify-center items-center text-center text-xl text-[#fffbe6]/90 bg-[#032d66] w-full`}>
