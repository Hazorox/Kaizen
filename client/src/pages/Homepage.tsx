          ...
          <div className="p-12 w-1/2 h-full flex justify-center items-center">
            <div className="bg-[#fffbe6] relatve flex flex-col justify-around items-center w-full border-8 h-full rounded-xl">
              <div className="w-full flex justify-center flex-col items-center gap-8">
                ...
                {login ? (
                  <>
                    <button className="bg-[#FF9A3C] p-4 w-[70%] rounded-full text-xl -mb-4">
                      {login ? "Login" : "Register"}
                    </button>
                    <button className="bg-[#FF9A3C] p-2 w-[70%] rounded-full flex justify-center text-xl items-center">
                      Continue With{" "}
                  ...
                  <>
                    <div className="flex w-[70%] rounded-xl border justify-around items-center bg-[#FF9A3C]">
                      <button className="border-r-2 h-full text-xl w-1/2">Register</button>
